<?php
/* Smarty version 3.1.28, created on 2016-09-09 23:09:06
  from "c:\wamp\www\britlibms\sync\templates\manuscript.tpl" */

if ($_smarty_tpl->smarty->ext->_validateCompiled->decodeProperties($_smarty_tpl, array (
  'has_nocache_code' => false,
  'version' => '3.1.28',
  'unifunc' => 'content_57d33302ba3b16_81244867',
  'file_dependency' => 
  array (
...
function content_57d33302ba3b16_81244867 ($_smarty_tpl) {
...
<body>
    <div class='container-fluid'>
        ...
        <div id='content-row' class='row'><div class='col-sm-12'>
            <h1><?php echo $_smarty_tpl->tpl_vars['record']->value[0];?>
 <?php echo $_smarty_tpl->tpl_vars['record']->value[1];?>
</h1>
            <?php if ($_smarty_tpl->tpl_vars['too_many_images']->value) {?><div class='alert alert-warning'>
                <span class='glyphicon glyphicon-picture'></span>
                <span class='glyphicon glyphicon-warning-sign'></span>
                This manuscript has
                too many images to view on one page.
                You can view 50 images at a time in the
                <a href='../gallery/?id=<?php echo $_smarty_tpl->tpl_vars['id']->value;?>
'>
            ...
            <button type='button' class='btn btn-primary'
                    ...
                    data-target='#manuscript-details-list'
            >
                <span class='glyphicon glyphicon-th-list'></span>
                Show/hide details
            </button>
            <div id='manuscript-details-list'
                 class='collapse<?php if ($_smarty_tpl->tpl_vars['too_many_images']->value) {?> in<?php }?>'
            >
                <dl>
                    <dt>Official foliation</dt>
                    <dd class='oneline'>
                    ...
                    <dt>Collation</dt>
                    <dd class='oneline'><?php echo $_smarty_tpl->tpl_vars['record']->value[5];?>
</dd>
                    <?php }?>
                    <dt>Form</dt>
                    <dd class='oneline'><?php echo $_smarty_tpl->tpl_vars['record']->value[3];?>
</dd>
                    <dt>Binding</dt>
                    <dd class='oneline'><?php echo $_smarty_tpl->tpl_vars['record']->value[4];?>
</dd>
                    <dt>Provenance</dt>
                    <dd><ul><?php
...
if ($_smarty_tpl->tpl_vars['details']->value[0]) {?> (<?php echo $_smarty_tpl->tpl_vars['details']->value[0];?>
                ...
                <?php if ($_smarty_tpl->tpl_vars['details']->value[1]) {?><h4>by <?php echo $_smarty_tpl->tpl_vars['details']->value[1];?>
</h4><?php }?>
                <div class='btn-group'>
                <button type='button' class='btn btn-primary'
                        data-toggle='collapse'
                        data-target='#part<?php echo $_smarty_tpl->tpl_vars['details']->value[10];?>
-details-list'
                >
                    <span class='glyphicon glyphicon-th-list'></span>
                    Show/hide details
...
-details-list'
                ...
                >
                    <dl>
                        ...
                        <dt>Origin</dt>
                        <dd class='oneline'><?php echo $_smarty_tpl->tpl_vars['details']->value[14];?>
</dd>
                        <?php }?>
...
?>
                        ...
                        <dt>Language</dt>
                        <dd class='oneline'><?php echo $_smarty_tpl->tpl_vars['details']->value[4];?>
</dd>
                        <?php }?>
                        <dt>Language list</dt>
                        <dd><ul>
...
&amp;grouping=p'>
                            ...
                            <?php if ($_smarty_tpl->tpl_vars['details']->value[12] && $_smarty_tpl->tpl_vars['details']->value[13]) {?></a><?php }?>
                        </dd>
                        <?php }?>
                        ...
                        <dt>Script</dt>
                        <dd class='oneline'><?php echo $_smarty_tpl->tpl_vars['details']->value[6];?>
</dd>
                        <?php }?>
...
?>
                        ...
                        <dt>Scribe</dt>
                        <dd class='oneline'><?php echo $_smarty_tpl->tpl_vars['details']->value[7];?>
</dd>
                        <?php }?>
...
?>
                        ...
                        <dt>Provenance</dt>
                        <dd><?php echo $_smarty_tpl->tpl_vars['details']->value[8];?>
</dd>
                        <?php }?>
                        <?php if ($_smarty_tpl->tpl_vars['details']->value[9]) {?>
                        <dt>Attribution</dt>
                        <dd class='oneline'><?php echo $_smarty_tpl->tpl_vars['details']->value[9];?>
</dd>
                        <?php }?>
                    </dl>
                </div>
...
?>
            ...
            <?php if (!($_smarty_tpl->tpl_vars['details']->last)) {?><hr><?php }?>
            <?php
